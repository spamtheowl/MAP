...
public class Interpreter
{
	private static PrgState createPrg(IStmt ex) {
		...
		PrgState prg = new PrgState(stk, symtbl, ot, fT, heap, ex);
		return prg;
	}
	...
	public static void main(String[] args) throws IOException, MyStmtException
	{
		...
		IStmt ex11 = new CompStmt(new AssignStmt("v", new ConstExp(10)), new CompStmt(new NouveauStmt("v", new ConstExp(20)), 
				new CompStmt(new NouveauStmt("a", new ConstExp(22)), new CompStmt(new WriteHeapStmt("a", new ConstExp(30)), 
						new CompStmt(new PrintStmt(new VarExp("a")), new CompStmt(new PrintStmt(new ReadHeapExp("a")),
