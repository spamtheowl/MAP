...
public class PrgState
{
	...
	public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Integer> symtbl, MyIList<Integer> ot, MyIDictionary<Integer, MyTuple<String, BufferedReader>> fT, MyIDictionary<Integer, Integer> h, IStmt prg, int i)
	{
		this.id = i + 1;
		exeStack = stk;
		symTable = symtbl;
